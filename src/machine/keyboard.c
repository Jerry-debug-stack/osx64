...
UNUSED static const uint16_t keymap[NR_SCAN_CODES][MAP_COLS] = {
...
UNUSED static const uint8_t PauseBreak[6] = { 0xE1, 0x1D, 0x45, 0xE1, 0x9D, 0xC5 };

/// @brief 键盘中断处理程序
void keyboard_handler_soft(void)
{
    set_EOI(0);
}
...
void init_keyboard(void)
{
    ...
    KeyboardStatus = kmalloc(sizeof(KEYBOARD_STATUS));
    memset((void*)KeyboardStatus, 0, sizeof(KEYBOARD_STATUS));
    enable_irq(1);
}
